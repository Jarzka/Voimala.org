                       ...
                       [:div (use-style blog-style/about-page)
                        [:div (use-style blog-style/about-frame)
                         ...
                         [:div (use-style blog-style/about-text)
                          ...
                          [:p "Haaveenani on kiertää kaikki Suomen 40 kansallispuistoa ja kirjoittaa jokaisesta pieni retkitarina. Reissu alkoi marraskuussa 2017 " [:a {:href "/blog/2017-11-17-ukk"} "Urho Kekkosen kansallispuistosta"] " ja matkalta puuttuu vielä 9 kansallispuistoa."]
