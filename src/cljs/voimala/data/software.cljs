...
(def projects [{:name               "Ajokit"
                ...
                :description-hiccup [ui/p "A simple grid-based traffic simulation application which also has a real-time map editing capability."]
               ...
               {:name               "JarzkaChess"
                ...
                :description-hiccup [:span
                                     ...
                                     [ui/p [ui/link {:href "https://www.youtube.com/watch?v=viFZeI8uAVU"} "Watch gameplay video on YouTube"]]]
               ...
               {:name               "MyRTS"
                ...
                :description-hiccup [:span
                                     ...
                                     [ui/p [ui/link {:href "https://www.youtube.com/watch?v=OEy6PhbeE_Y"} "Watch gameplay video on YouTube"]]]
               ...
               {:name               "Multithreaded Game of Life"
                ...
                :description-hiccup [:span
                                     ...
                                     [ui/p [ui/link {:href "images/game_of_life_example.gif"} "View example output GIF"]]]
                :date-released         (t/date-time 2014 4 18)
                :technologies-used  #{:java}
                :tags               #{:game}
                :importance         2}
               {:name               "PresentationApp"
                ...
                :description-hiccup [ui/p "A simple HTML5 application that can be used to create PowerPoint-like presentations. The app features custom themes and fades and has also built-in support for simple bar charts."]
               ...
               {:name               "ThisSimpleMarquee"
                ...
                :description-hiccup [ui/p "A simple HTML5 marquee library. Supports 2 different fades, autoplay and is also touch-friendly."]
               ...
               {:name               "Library GUI"
                ...
                :description-hiccup [ui/p "A library GUI made with Qt Framework and C++."]
               ...
               {:name               "Trade Wars 3"
                ...
                :description-hiccup [:span
                                     ...
                                     [ui/p [ui/link {:href "http://www.youtube.com/watch?v=8R-gvi1MddY"} "Watch trailer on YouTube"]]
                                     [ui/p "There is an article about this game in "
                                      [ui/link {:href "http://games.softpedia.com/get/Freeware-Games/Trade-Wars-3.shtml"} "Softpedia"] ", "
                                      [ui/link {:href "http://www.novinky.cz/internet-a-pc/138621-hrajeme-zdarma-trade-wars-3-akcni-lemmings.html"} "Novinky"] " and "
                                      [ui/link {:href "http://plnehry.idnes.cz/trade-wars-3-lemmings-ve-vojenskem-drf-/Clanek.aspx?c=A080423_124626_bw-plneHry-logicke_bw"} "CZC"] "."]]
                :year-released         2008
               ...
               {:name               "Trade Wars 2"
                ...
                :description-hiccup [:span
                                     ...
                                     [ui/p "This game was the game of the week in "
                                      [ui/link {:href "images/tradewars2gotw.jpg"} "The Daily Click "] " in June 2006."]]
               ...
               {:name               "Real Pilkki"
                ...
                :description-hiccup [:span
                                     ...
                                     [ui/p "The game was reviewed in Finnish magazine "
                                      [ui/link {:href "images/real_pilkki_mbnet_2005.jpg"} "Mikrobitti"] " in 2005."]]
                :year-released         2005
                :technologies-used  #{:multimedia-fusion-2}
                :tags               #{:game}
                :importance         2}
               {:name               "Saunasata"
                ...
                :description-hiccup [ui/p "Saunasata is a sauna themed platform game, made for the Suomipelit.com Summer Contest in 2004. The game was developed using The Games Factory."]
                :year-released        2004
                :technologies-used  #{:multimedia-fusion-2}
                :tags               #{:game}
                :importance         2}
               {:name               "MertaScript"
                ...
                :description-hiccup [:span
                                     ...
                                     [ui/p "There is " [ui/link {:href "http://www.youtube.com/watch?v=p4RFxspj2Pk"} "a demostration video available on YouTube"] " in which the script is used with Antero Mertaranta's voice."]]
