...
var G__38039 = o;
(G__38039[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__38074__i < G__38074__a.length) {G__38074__a[G__38074__i] = arguments[G__38074__i + 0]; ++G__38074__i;}
  args = new cljs.core.IndexedSeq(G__38074__a,0,null);
} 
...
var G__38040 = o;
(G__38040[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__38076__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__38077__i < G__38077__a.length) {G__38077__a[G__38077__i] = arguments[G__38077__i + 0]; ++G__38077__i;}
  args = new cljs.core.IndexedSeq(G__38077__a,0,null);
} 
return G__38076__delegate.call(this,args);};
G__38076.cljs$lang$maxFixedArity = 0;
G__38076.cljs$lang$applyTo = (function (arglist__38078){
var args = cljs.core.seq(arglist__38078);
return G__38076__delegate(args);
});
...
var G__38042 = props;
var G__38042__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__38042,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__38042);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__38042__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__38043){
var map__38044 = p__38043;
var map__38044__$1 = (((((!((map__38044 == null))))?(((((map__38044.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__38044.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__38044):map__38044);
var props = map__38044__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38044__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__38051){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38052__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
var G__38055 = jsprops;
(G__38055["defaultValue"] = value);

(G__38055["onChange"] = (function (p1__38054_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__38054_SHARP_);
}));
...
var vec__38057 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38057,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38057,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38057,(2),null);
...
var jsprops = ({"argv": v});
var temp__5739__auto___38139 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___38139 == null)){
} else {
var key_38140 = temp__5739__auto___38139;
(jsprops["key"] = key_38140);
}
...
var temp__5739__auto___38141 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___38141 == null)){
} else {
var key_38142 = temp__5739__auto___38141;
reagent.impl.template.oset(jsprops,"key",key_38142);
}
...
var G__38061 = reagent.impl.template.__GT_NativeWrapper();
(G__38061["name"] = c);
...
var G__38062 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__38062) : reagent.impl.template.as_element.call(null,G__38062));
} else {
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq38065){
var G__38066 = cljs.core.first(seq38065);
var seq38065__$1 = cljs.core.next(seq38065);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38066,seq38065__$1);
}));
...
break;
default:
var G__38148 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__38148;
continue;
...
var n__4607__auto___38151 = a.length;
var i_38152 = (0);
while(true){
if((i_38152 < n__4607__auto___38151)){
(a[i_38152] = reagent.impl.template.as_element((a[i_38152])));

var G__38153 = (i_38152 + (1));
i_38152 = G__38153;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___38154 = a.length;
var i_38155 = (0);
while(true){
if((i_38155 < n__4607__auto___38154)){
var val_38156 = (a[i_38155]);
if(((cljs.core.vector_QMARK_(val_38156)) && ((reagent.impl.template.key_from_vec(val_38156) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_38155] = reagent.impl.template.as_element(val_38156));

var G__38157 = (i_38155 + (1));
i_38155 = G__38157;
continue;
} else {
}
...
var G__38072 = (cljs.core.count(argv) - first_child);
switch (G__38072) {
case (0):
