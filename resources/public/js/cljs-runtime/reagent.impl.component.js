...
if((i < len)){
var k = (ks[i]);
var G__38032 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__38033 = (i + (1));
m = G__38032;
i = G__38033;
continue;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__37919 = c;
var G__37919__$1 = (((G__37919 == null))?null:G__37919.prototype);
if((G__37919__$1 == null)){
return null;
} else {
return (G__37919__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__37921 = c;
var G__37921__$1 = (((G__37921 == null))?null:G__37921.prototype);
if((G__37921__$1 == null)){
return null;
} else {
return (G__37921__$1["render"]);
}
})() == null)))));
});
...
var G__37930 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__37930) : reagent.impl.component.as_element.call(null,G__37930));
};
...
while (G__38036__i < G__38036__a.length) {G__38036__a[G__38036__i] = arguments[G__38036__i + 0]; ++G__38036__i;}
  args = new cljs.core.IndexedSeq(G__38036__a,0,null);
} 
...
var _STAR_current_component_STAR__orig_val__37933 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__37934 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__37934);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__37933);
}});
...
var c = this;
var G__37944_38047 = (c["cljsRatom"]);
if((G__37944_38047 == null)){
} else {
reagent.ratom.dispose_BANG_(G__37944_38047);
}
...
var renders_38048 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_38049 = cljs.core.first(cljs.core.vals(renders_38048));
if((cljs.core.count(renders_38048) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_38048))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_38049)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_38049], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var render_fun__$1 = (function (){var or__4120__auto__ = render_fun;
if(cljs.core.truth_(or__4120__auto__)){
return or__4120__auto__;
} else {
...
var name = cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__4120__auto__ = new cljs.core.Keyword(null,"displayName","displayName",-809144601).cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__4120__auto__)){
return or__4120__auto__;
} else {
...
var name__$1 = (function (){var G__37945 = name;
switch (G__37945) {
case "":
...
var name = (function (){var G__37961 = fiber;
var G__37961__$1 = (((G__37961 == null))?null:(G__37961["type"]));
if((G__37961__$1 == null)){
return null;
} else {
return (G__37961__$1["displayName"]);
}
})();
var parent = (function (){var G__37962 = fiber;
if((G__37962 == null)){
return null;
} else {
return (G__37962["return"]);
}
})();
var path = (function (){var G__37968 = parent;
var G__37968__$1 = (((G__37968 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__37968) : reagent.impl.component.fiber_component_path.call(null,G__37968)));
if((G__37968__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__37968__$1)," > "].join('');
}
})();
...
var temp__5733__auto__ = (function (){var or__4120__auto__ = (function (){var G__37987 = c;
if((G__37987 == null)){
return null;
} else {
return (G__37987["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4120__auto__)){
return or__4120__auto__;
...
var instance = (function (){var or__4120__auto__ = (function (){var G__37990 = c;
if((G__37990 == null)){
return null;
} else {
return (G__37990["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4120__auto__)){
return or__4120__auto__;
} else {
var or__4120__auto____$1 = (function (){var G__37992 = c;
if((G__37992 == null)){
return null;
} else {
return G__37992._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4120__auto__ = (function (){var G__37998 = instance;
if((G__37998 == null)){
return null;
} else {
return (G__37998["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4120__auto__)){
return or__4120__auto__;
} else {
var G__38004 = instance;
if((G__38004 == null)){
return null;
} else {
return G__38004._currentElement;
}
}
})();
var name = (function (){var G__38007 = elem;
var G__38007__$1 = (((G__38007 == null))?null:(G__38007["type"]));
if((G__38007__$1 == null)){
return null;
} else {
return (G__38007__$1["displayName"]);
}
})();
var owner = (function (){var or__4120__auto__ = (function (){var G__38019 = elem;
if((G__38019 == null)){
return null;
} else {
return (G__38019["_owner"]);
}
})();
if(cljs.core.truth_(or__4120__auto__)){
return or__4120__auto__;
...
return G__38020._owner;
}
}
})();
var path = (function (){var G__38022 = owner;
var G__38022__$1 = (((G__38022 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__38022) : reagent.impl.component.component_path.call(null,G__38022)));
if((G__38022__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__38022__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var n = (function (){var or__4120__auto__ = reagent.impl.component.component_path(c);
if(cljs.core.truth_(or__4120__auto__)){
return or__4120__auto__;
} else {
var G__38024 = c;
var G__38024__$1 = (((G__38024 == null))?null:G__38024.constructor);
if((G__38024__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__38024__$1);
}
}
})();
