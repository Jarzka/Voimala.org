...
var cljs$tools$reader$reader_types$Reader$peek_char$dyn_26611 = (function (reader){
var x__4422__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_26611(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_26612 = (function (reader,ch){
var x__4422__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_26612(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_26613 = (function (reader){
var x__4422__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_26613(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_26614 = (function (reader){
var x__4422__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_26614(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_26615 = (function (reader){
var x__4422__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_26615(reader);
}
});
...
var G__26651 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__26652 = s.append(c);
c = G__26651;
s = G__26652;
continue;
}
